  ...
  MaterialApp _routeApp() {
    return MaterialApp(
      ...
      onGenerateRoute: (setting) {
        ...
        WidgetBuilder? builder = routes[setting.name] as WidgetBuilder?;
        if (builder != null) {
    ...
    return Scaffold(
      ...
      body: Center(
        child: ElevatedButton(
          child: Text('点击前往CCC'),
          onPressed: () {
            var backValueFromDDD =
                Navigator.pushNamed(context, '/ccc', arguments: {'value': "我是BBB页面传过来的值"});
        ...
        ListTile(
          ...
          onTap: () {
            Navigator.of(context)
                .pushNamedAndRemoveUntil('/ddd', (route) => route.settings.name == '/ddd');
          },
        ),
        ListTile(
...
class DDD extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    Object? test = ModalRoute.of(context)?.settings.arguments;
    // TODO: implement build
    return Scaffold(
      appBar: AppBar(
        title: Text("DDD"),
